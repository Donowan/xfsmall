...
Page({
  ...
  onLoad: function (options) {
    ...
    if (options.kind_id) {
      let { kind_id } = options;
      get_commodity_by_kind(kind_id,this.data.page).then(res=>{
        console.log(res)
  ...
  onReachBottom: function () {
    if(this.data.options.kind_id){
      lower({
        _this: this,//this
        request: get_commodity_by_kind,//调用api
        array: [this.data.options.kind_id],//传递参数
